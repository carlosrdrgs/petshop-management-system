...
<title>PetShop Cão Q-Late - Alterar Cão</title>
	...
	<div class="container-fluid">
		<div class="row">
			...
			<div class="col-sm-9 col-md-10 main-content">
				<h1 class="page-header">Alterar Cão</h1>
				...
				<form action="controladora" method="post" class="form-cadastro">
					<input type="hidden" name="logica" value="ProcessaAlteraCaoLogica">
					<input type="hidden" name="id" value="${cao.id}">

					<div class="form-group">
						<label for="nome">Nome:</label> <input type="text"
							class="form-control" id="nome" name="nome" value="${cao.nome}"
							required />
					</div>
					<div class="form-group">
						<label for="raca">Raça:</label> <input type="text"
							class="form-control" id="raca" name="raca" value="${cao.raca}"
							required />
					</div>
					<div class="form-group">
						<label>Porte:</label>
						<div class="radio">
							<label><input type="radio" id="porte_p" name="porte"
								value="PEQUENO" required
								<c:if test="${cao.porte == 'PEQUENO'}">checked</c:if>>Pequeno</label>
						</div>
						<div class="radio">
							<label><input type="radio" id="porte_m" name="porte"
								value="MEDIO"
								<c:if test="${cao.porte == 'MEDIO'}">checked</c:if>>Médio</label>
						</div>
						<div class="radio">
							<label><input type="radio" id="porte_g" name="porte"
								value="GRANDE"
								<c:if test="${cao.porte == 'GRANDE'}">checked</c:if>>Grande</label>
						</div>
					</div>
					...
					<a href="controladora?logica=ListaCaoLogica"
