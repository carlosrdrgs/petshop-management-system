...
<title>Cadastrar Novo Serviço - PetShop Cão Q-Late</title>
		...
		<div class="row">
			...
			<div class="col-sm-9 col-md-10 main-content">
				...
				<form action="controladora" method="post" class="form-cadastro">
					<input type="hidden" name="logica" value="AdicionaServicoLogica">
					...
					<button type="submit" class="btn btn-success">
						<span class="glyphicon glyphicon-ok"></span> Salvar Serviço
					</button>
