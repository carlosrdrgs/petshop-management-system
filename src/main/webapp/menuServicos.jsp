...
<title>Lista de Serviços - PetShop Cão Q-Late</title>
	...
	<div class="container-fluid">
		<div class="row">
			...
			<div class="col-sm-9 col-md-10 main-content">
				<h1 class="page-header">Serviços Disponíveis</h1>
				...
				<p>
					<a href="controladora?logica=CadastraServicoLogica"
						class="btn btn-primary"> <span
						class="glyphicon glyphicon-plus"></span> Adicionar Novo Serviço
					</a>
				</p>
								...
								<tr>
									...
									<td class="action-buttons">
										...
										<form action="controladora" method="post">
											<input type="hidden" name="logica"
												value="RemoveServicoLogica"> <input type="hidden"
												name="id" value="${servico.id}">
