...
<title>PetShop Cão Q-Late - Cadastrar Administrador</title>
		...
		<div class="row">
			<div class="col-sm-3 col-md-2 sidebar">
				...
				<ul class="nav nav-pills nav-stacked">
					<li class="active"><a
						href="controladora?logica=ListaAdministratorLogica">Administradores</a></li>
			...
			<div class="col-sm-9 col-md-10 main-content">
				...
				<form action="controladora" method="post" class="form-cadastro">
					<input type="hidden" name="logica"
						value="AdicionaAdministratorLogica">

					<div class="form-group">
						<label for="login">Login:</label> <input type="text"
							class="form-control" id="login" name="login"
							value="${loginParam}" required />
					</div>
					...
					<div class="form-group">
						<label for="confirmaSenha">Confirmar Senha:</label> <input
							type="password" class="form-control" id="confirmaSenha"
					...
					<a href="controladora?logica=ListaAdministratorLogica"
