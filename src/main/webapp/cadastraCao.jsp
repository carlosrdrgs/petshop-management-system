...
<title>PetShop Cão Q-Late - Cadastrar Cão</title>
	...
	<div class="container-fluid">
		<div class="row">
			...
			<div class="col-sm-9 col-md-10 main-content">
				<h1 class="page-header">Cadastrar Novo Cão</h1>
				...
				<c:if test="${not empty erroCpf}">
					<div class="alert alert-danger" role="alert">
						<span class="glyphicon glyphicon-exclamation-sign"
							aria-hidden="true"></span> ${erroCpf}
					</div>
				</c:if>

				<form action="controladora" method="post" class="form-cadastro">
					<input type="hidden" name="logica" value="AdicionaCaoLogica">
					...
					<div class="form-group">
						<label for="raca">Raça:</label> <input type="text"
							class="form-control" id="raca" name="raca" required />
					</div>
					<div class="form-group">
						<label>Porte:</label>
						<div class="radio">
							<label><input type="radio" id="porte_p" name="porte"
								value="PEQUENO" required>Pequeno</label>
						</div>
						<div class="radio">
							<label><input type="radio" id="porte_m" name="porte"
								value="MEDIO">Médio</label>
						</div>
						<div class="radio">
					...
					<div class="form-group">
						<label for="cpf">CPF do Dono:</label> <input type="text"
							class="form-control" id="cpf" name="cpf"
							placeholder="CPF do cliente já cadastrado" required />
					</div>

					<button type="submit" class="btn btn-success">
						<span class="glyphicon glyphicon-ok"></span> Cadastrar Cão
					</button>
