<%@ page language="java" contentType="text/html; charset=UTF-8"
 ...
 <title>PetShop Cão Q-Late - Administradores</title>
    ...
    <div class="row">
        <div class="col-sm-3 col-md-2 sidebar">
            ...
            <ul class="nav nav-pills nav-stacked">
                <li class="active"><a href="controladora?logica=ListaAdministratorLogica">Administradores</a></li>
        ...
        <div class="col-sm-9 col-md-10 main-content">
            <h1 class="page-header">Gestão de Administradores</h1>

            <p><a href="cadastra-administrator.jsp" class="btn btn-primary">
               <span class="glyphicon glyphicon-plus"></span> Cadastrar Novo Administrador
            </a></p>
